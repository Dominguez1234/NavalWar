...
//		frame.setFocusable(true);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(index<=4){
	     ...
	     int i =0;
 		String[] img;
 		img =BoatImageProvider.getImageFile(al.get(index).getNom(), dir); // On r�cupere les images correspondant au bateau dans un tab
...
//Si on veut juste colori� en vert	        	varx = o.x * ((c.getWidth()));
//	        	vary = o.y * ((c.getWidth()));
